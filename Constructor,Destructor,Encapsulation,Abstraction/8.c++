...
member var                                                                                                                                                            iables for name, class, roll number, and marks. Include
...
int main()
{
	Student s1(101,"NARUTO",75,65,12);
	Address a1("KONOHA",&s1);
	
	Student s2(102,"SHINCHAN",85,90,11);
	Address a2("KASHUKABE",&s2);
